...
function changerDirection(event) {
    ...
    // je veux aller à gauche (premier cas)
    ...
    // donc si on va à droite, "adroite === true", j' écriq !adroite (inverse de adroite, donc false) pour empecher la condition && de s'executer.
